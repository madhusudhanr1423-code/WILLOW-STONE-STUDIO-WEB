    ...
    <div>
      <section className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          <div className="min-w-0 overflow-hidden rounded-3xl shadow-[var(--shadow-lift)]">
            <img
              src={heroImage}
      ...
      <section className="border-y border-border/70 bg-secondary/40">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20">
          <div className="max-w-2xl">
            <h2 className="text-3xl font-semibold sm:text-4xl">What guides how we work</h2>
          </div>
          <div className="mt-10 grid gap-6 sm:grid-cols-3">
            {values.map((v) => (
              <Card key={v.title} className="rounded-2xl border-border/70 shadow-[var(--shadow-soft)] hover-lift">
